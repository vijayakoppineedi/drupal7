...
class App {
    ...
    public function get_fallback() {	
      ...
      $match_result = preg_match('/^data/', substr($_SERVER['REQUEST_URI'], 1), $matches);	  
      if ((count($split) > 6) || (($match_result == 1) && (count($match_result) != 0)) ) {	
        ...
        $folder_img = 'h5ai/';  $width = "width='24px'"; $target = " target='_blank'";
        ...
        if ($folder->get_parent($cache)) {
            $html .= "<tr>";
            $html .= "<td class='fb-i'><img src='" . APP_HREF . $folder_img."client/images/fallback/folder-parent.png' alt='folder-parent' ".$width."/></td>";
        ...
        foreach ($items as $item) {
            ...
            $html .= "<tr>";
            $html .= "<td class='fb-i'><img src='" . APP_HREF . $folder_img."client/images/fallback/" . $type . ".png' alt='" . $type . "' ".$width."/></td>";
            $html .= "<td class='fb-n'><a href='" . $item->url. "'".$target.">" . basename($item->path) . "</a></td>";
        ...
        $html .= "</table>";
        } // if condition to check the organism node id and species data exists 
		else {
