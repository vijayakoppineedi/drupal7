...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <![endif]-->
  <?php print $scripts; ?>
 <!-- <script type="text/javascript" src="/sites/all/themes/i5k_bootstrap/i5k-bootstrap-sass/js/outboundlinks.js"></script> -->
  <script>
  jQuery(document).ready(function() {
    jQuery(".emailLnk a").on('click',function(e){
    ...
    }); //CLICK event closing braces

 });  //Document ready closing braces
 </script>
