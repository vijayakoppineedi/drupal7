...
$organism_filename = ''; $image_url = '';
if(isset($node->field_organism_image['und'][0]['uri'])) {
...
<br>
<?php if(isset($variables['node']->field_image_credit['und'][0]['value'])) { ?>
<div style="text-align: justify">Image Credit: <?php print $variables['node']->field_image_credit['und'][0]['value']; ?> </div>  
<?php } ?>
