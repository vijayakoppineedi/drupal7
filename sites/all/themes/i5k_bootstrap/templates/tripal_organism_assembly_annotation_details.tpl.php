...
?>
<div id="assembly_annotation_details" class="row">   
  <div class="assembly_details col-sm-8">
  ...
  <div class="statistics_details col-sm-4">
    <h2>Statistics</h2>
    ...
    <tr class="tripal_organism-table-even-row tripal-table-even-row">
      <td colspan=1 class="tripal_organism-table-even-row" id="assembly-metrics-table"><b>Assembly Metrics</b></td>      
    </tr>
