...
echo "hellloooooooooo ";exit;
  ...
  jQuery(document).ready(function($){    	  
	 ...
	 $(".tripal_toc_list_item").each(function(i,v){       	  
	   ...
	   if(item_title == 'Scaffold N50' || item_title == 'Organism Image' || item_title == 'Feature Browser' || item_title == 'Feature Summary' || item_title == 'Comments' || item_title == 'GC Content' || item_title == 'Contig N50' || item_title == 'Number Of Genes' || item_title == 'Community Contact' ||(item_title.match(/^Annotation([0-9]+)$/))) { 		
		  $(v).hide();		  
		} 		        
