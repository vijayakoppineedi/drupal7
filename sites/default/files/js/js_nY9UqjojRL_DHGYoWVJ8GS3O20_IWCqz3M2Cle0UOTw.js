...
;
/*
$('#edit-organism').bind('change', function () { // bind change event to select
  alert("hello ");
var organism = $(this).val(); // get selected value
  if (organism == 'New Organism') { // require a URL
    window.location = "/datasets/request-project"; // redirect
  }
  return false;
});
*/
